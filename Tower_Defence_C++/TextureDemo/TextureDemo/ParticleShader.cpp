...
ParticleShader::ParticleShader(const char *vertPath, const char *fragPath) {
...
void ParticleShader::AttributeBinding(){
...
void ParticleShader::setUniform1i(const GLchar *name, int value) {
	glUniform1i(glGetUniformLocation(shaderProgram, name), value);
}

// Sets a uniform float variable in your shader program to a value
void ParticleShader::setUniform1f(const GLchar *name, float value) {
	glUniform1f(glGetUniformLocation(shaderProgram, name), value);
}

// Sets a uniform vector2 variable in your shader program to a vector
void ParticleShader::setUniform2f(const GLchar *name, const glm::vec2 &vector) {
...
void ParticleShader::setUniform3f(const GLchar *name, const glm::vec3 &vector) {
...
void ParticleShader::setUniform4f(const GLchar *name, const glm::vec4 &vector) {
...
void ParticleShader::setUniformMat4(const GLchar *name, const glm::mat4 &matrix) {
